<?php
  ...
  $orders = $h->getAllSelect("o.id, titleOrder, titleCate, postDate, o.created_at as createdAt", "$tableOrder as o, $tableCateOrder as c", $where." and o.cateID = c.id", "o.created_at desc, o.sortOrder desc, o.id desc", "limit $start,$per_page");
  $msg .= '<h2 class="itemTitle text-uppercase">'._e($lang['relatedOrder']).'</h2>';
  ...
  foreach ($orders as $order) {
    ...
    $msg .= '<li><a href="'.$linkOrder.'"><i class="fa fa-long-arrow-right" aria-hidden="true"></i> '.$titleOrder.' <i>('.$postDate.')</i></a></li>';
  }
  $msg .= '</ul></div>';
